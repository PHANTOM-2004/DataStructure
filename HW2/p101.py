...
for i in range(1, test_num + 1) :
    ...
    base_num = np.random.randint(-1000000000,1000000000) # min(m)，反正打不了表，也没必要取到0x80000000�?0x7fffffff�?( ＾皿�?)っHiahiahia�?
    Que = Queue(que_size)
